<?php
/**
 * This file contains an standalone zipping class based on dZip class by Alexandre Tedeschi.
 * 
 * @author		Mehran Ahadi
 * @package		Arta
...
/**
 * Zipper for ArtaArchive based on dZip class.
 * This is a modified version of Alexandre Tedeschi's dZip class.
 */
class ArtaArchive_zip{
	var $filename;
	var $overwrite;
	...
	Function ArtaArchive_zip($filename, $overwrite=true){
		$this->__construct($filename, $overwrite);
	}
