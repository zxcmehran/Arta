 ...
 */
require_once(ARTAPATH_LIBRARY.'/pdf/tcpdf/config/tcpdf_config.php');
 ...
 * unicode data
 */
require_once(ARTAPATH_LIBRARY.'/pdf/tcpdf/unicode_data.php');

/**
 * html colors table
 */
require_once(ARTAPATH_LIBRARY.'/pdf/tcpdf/htmlcolors.php');

/**
 * barcode class
 */
require_once(ARTAPATH_LIBRARY.'/pdf/tcpdf/barcodes.php');
	...
	class TCPDF {
		...
		*/
		...
		public function __construct($orientation='P', $unit='mm', $format='A4', $unicode=true, $encoding='UTF-8', $diskcache=false) {
			...
			$this->InFooter = false;
			$this->lasth = 0;
			/*$this->FontFamily = 'helvetica';*/$this->FontFamily = 'dejavusans'; /*Disabled by Mehran Ahadi*/
			$this->FontStyle = '';
			$this->FontSizePt = 12;
